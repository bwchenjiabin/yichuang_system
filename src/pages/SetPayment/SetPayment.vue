            ...
            <div class="warrant">
              <div class="warrant_left">
                  ...
                  <div class="l_box" style="display: block;">
                      <p><span class="l_span">微信商户号：</span> <el-input v-model="input" placeholder="请输入内容"></el-input></p>
                      <p class="l_select" style="margin-top:25px;">
                          <a href="javascript:;" style="margin-right: 100px;">点击查看详细教程</a>
                      </p>
                  </div><br>
                  <div class="l_box" style="display: block;">
                      <p><span class="l_span">微信商户API密钥：</span> <el-input v-model="input" placeholder="请输入内容"></el-input></p>
                      <p class="l_select" style="margin-top:25px;">
                          <a href="javascript:;" style="margin-right: 100px;">点击查看详细教程</a>
                      </p>
                  </div><br>
                  <div class="l_box" style="display: block;">
                      <p><span class="l_span">支付授权目录(https):</span> <el-button type="primary">点击获取</el-button></p>
                      <p class="l_select" style="margin-top:25px;">
                          <a href="javascript:;" style="margin-right: 100px;">点击查看详细教程</a>
                      </p>
                  </div><br>
            ...
            <div class="warrant_footer">
                <div class="warrant_foot">
                    ...
                    <div class="warran_button">
                        ...
                        <router-link to="/verifyPayment"><el-button type="primary">下一步</el-button></router-link>
                    </div>
                </div>
