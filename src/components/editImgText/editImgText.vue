<template>
        <div class="box">
                <el-main>
                      <div>
                          <router-link to=""><span class="course" @click="switchss">我的课程</span>&nbsp;&nbsp;&nbsp;</router-link>/&nbsp;&nbsp;&nbsp;<span class="imgText">编辑图文</span><br><br>
                            <div class="title">
                                <i class="icon"></i>
                               ...
                               <!-- <div class="Mask">
                                    <div>
                                        <img src="../../../static/img/矢量智能对象@2x (1)_看图王.png" alt="" style="z-index:9999"> 
                                    </div>      
                               </div> -->                               
                                <br><br>
                               ...
                               <el-upload class="avatar-uploader" action="https://jsonplaceholder.typicode.com/posts/" :show-file-list="false" :on-success="handleAvatarSuccesse"
                                  :before-upload="beforeAvatarUpload">
                                  <img v-if="imageUrl1" :src="imageUrl1" class="avatarr">
            ...
            <el-dialog title="" :visible.sync="delVisiblee" width="600px" center style="z-index: 999">     
                <div class="del-dialog-cnt">       
                  ...
                  <el-input placeholder="请输入节标题" v-model="input5" clearable maxlength="12"> </el-input>
                  <span class="number">{{this.input1.length}}/12</span><br><br><br>
                  <quill-editor 
                    v-model="content" 
                    ref="myQuillEditor" 
...
import Header from '@/components/Header/Header.vue'
    export default {
        data(){
            return{
                input:'最新的金融学习方法是什么？',        // 课程名称
                input1:'大佬教你怎样创业',       // 章节标题1
                input5:'',       //修改节标题
                input2:'',       // 章节标题2
                input3:'',       // 收费价格
                input4:'',       // 划线价
                imageUrl: '../../../static/img/1491557776054_.pic_hd@2x@2x.png',    // 课程封面
                imageUrl1:'../../../static/img/微信图片_20190620142459.png',    // 详情封面
                textarea:'种种迹象表明，知识付费的时代已经来临了，而该如何把握住这个知识付费的风口呢？',     // 课程简介
                radio: '1',      // 上架时间
                radios: '2',     // 获取形式
                radio1:'1',      // 免费
                radio2:'1',      // 选择分类
                ...
                editorOption:{
                  modules:{
                        toolbar:[
                          ['bold', 'italic', 'underline', 'strike','image','video','align','formula','link','background','code-block'],        // toggled buttons
